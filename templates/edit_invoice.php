<?php foreach ($editable_formatted_names as $key => $value): ?>
    ...
    <?php if (in_array($editable_field_names[$key], $required_fields)): ?>
        ...
        <select name="customer_id" class="form-control" id="<?php echo strtoupper(str_replace(' ', '', $editable_formatted_names[$key])); ?>_edit" placeholder="Enter item name">
        ...
        <select name="<?php echo $editable_field_names[$key]; ?>" class="form-control" id="<?php echo strtoupper(str_replace(' ', '', $editable_formatted_names[$key])); ?>_edit">
